module TellStick
  module RawAPI
    ...
    # TellStick library requires that all strings it creates need to be released with a special function.
    # So we copy the string over to ruby, and release the old pointer.
    #
    # This MUST be done for all functions that return char*
